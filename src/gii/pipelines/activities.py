...
async def compute_and_store_index(params: PipelineParams) -> int:
    ...
    for score in scores:
        repo.upsert_snapshot(
            ...
            geopolitics_avg_goldstein=score.geopolitics_avg_goldstein,
            geopolitics_cooperative_ratio=score.geopolitics_cooperative_ratio,
            geopolitics_event_count=score.geopolitics_event_count,
